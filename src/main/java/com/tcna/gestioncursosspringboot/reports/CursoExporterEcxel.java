package com.tcna.gestioncursosspringboot.reports;
...
public class CursoExporterEcxel {

    //Todo sale de org.apache.poi.ss.usermodel
    private XSSFWorkbook workbook;
    private XSSFSheet sheet;
    private List<Curso> cursos;
    public CursoExporterEcxel(List<Curso> cursos) {
        this.cursos = cursos;
    ...
    private void writeHeaderLine(){
        ...
        Row row = sheet.createRow(0);       //Empieza en la fila 0 columna 0
        ...
        createCell(row, 2, "Descrpcion", style);
